        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <span class="form-text text-black-50">{#field_fecha#}</span>
                </div>
                <div class="col-lg-6">
                    <label>{#field_monto#}<span class="text-danger bold">*</span> :</label>
                    <div class="input-group">
                        <input type="text" class="form-control number_decimal pr-5" id="number_decimal"
