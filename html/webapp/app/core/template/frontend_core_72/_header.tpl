...
<div id="kt_header" class="header header-fixed">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                ...
                <ul class="menu-nav">
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <span class="menu-text">DIPREVCON</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                            <ul class="menu-subnav">
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="https://www.mingobierno.gob.bo" target="_blank" class="menu-link">
                                        <i class="fab fa-react mr-2"></i>
                                        <span class="menu-text">Web Ministerio de Gobierno </span>
                                        <!--<span class="menu-label"><span class="label label-success label-rounded">2</span></span>-->
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="https://www.facebook.com/Diprevcon" target="_blank" class="menu-link">
                                        <i class="fab fab fa-facebook mr-2"></i>
                                        <span class="menu-text">Facebook DIPREVCON</span>
                                    </a>
                                </li>
                                <li class="menu-item" aria-haspopup="true">
                                    <a href="https://app.mingobierno.gob.bo/diprevcon/" target="_blank" class="menu-link">
                                        <i class="fas fa-info mr-2"></i>
                                        <span class="menu-text">Oficina Virtual (SIG-RRHH)</span>
                                    </a>
                                </li>
        ...
        <div class="topbar">
            {if $userInfo}
            <!--begin::Search-->
            <div class="dropdown d-none" id="kt_quick_search_toggle" >
                <!--begin::Toggle-->
            ...
            <div class="dropdown d-none">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(/themes/metro72/assets/media/misc/bg-1.jpg)">
                            <!--begin::Title-->
            ...
            <div class="dropdown ">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <!--begin:Header-->
                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(/themes/metro72/assets/media/misc/bg-1.jpg)">
                        <h4 class="text-white font-weight-bold">Accesos rápidos</h4>
                    ...
                    <div class="row row-paddingless">
                        ...
                        <div class="col-6">
                            <a href="/" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">DIPREVCON</span>
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="/setting" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
                                <span class=""><i class="fa fa-cogs text-success icon-xl-2x"></i></span>
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Coniguración</span>
                                <span class="d-block text-dark-50 font-size-lg">Del sistema</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="https://www.facebook.com/Diprevcon" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                <span class=""><i class="fas fa-book text-success icon-xl-2x"></i></span>
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">DIPREVCON</span>
                                <span class="d-block text-dark-50 font-size-lg">Facebook</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="https://www.mingobierno.gob.bo" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light">
                                ...
                                <span class="d-block text-dark-50 font-size-lg">Ministerio de Gobierno</span>
                            </a>
                        </div>
                        <!--end:Item-->
                    </div>
            ...
            <div class="dropdown d-none">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm" src="/themes/metro72/assets/media/svg/flags/en.svg" alt="">
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right" style="">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="/themes/metro72/assets/media/svg/flags/en.svg" alt="">
													</span>
                        ...
                        <li class="navi-item active">
                            <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="/themes/metro72/assets/media/svg/flags/es.svg" alt="">
													</span>
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold">{$userInfo.name[0]}</span>
                    </span>
                </div>
            </div>
            <!--end::User-->
                ...
                <div class="topbar-item">
                    <div class="w-auto d-flex align-items-center px-2">
                        <a href="/login" class="btn btn-success font-weight-bold mr-2">Entrar</a>
                    </span>
                    </div>
                </div>
            {/if}
