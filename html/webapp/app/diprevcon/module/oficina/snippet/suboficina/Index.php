<?PHP
namespace App\Diprevcon\Module\Oficina\Snippet\suboficina;
use Core\CoreResources;
class Index extends CoreResources
{
    var $objTable = "oficina";
    var $folder = "suboficina";
    var $fkey_field = "parent";
...
//                    $dataResult["activo"] = "true";
                    ...
                    $dataResult["entidad_id"] = $item["entidad_id"];
    ...
    function getItem($id){
        $sql = "select p.entidad_id from ".$this->table[$this->objTable]." as p where p.id = '".$id."'";
