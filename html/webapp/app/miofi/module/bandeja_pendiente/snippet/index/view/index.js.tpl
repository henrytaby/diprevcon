...
<div class="col-lg-6">
    ...
    <strong>Receptor Oficina:</strong> ${val.receptor_oficina}
        ...
        var html_Bottom = function(val){
            ...
            html += iconos_abajo("Fecha Recepcion",val.fecha_recepcion,"text-info","fas fa-calendar-check","text-info font-weight-bold");
            ...
            html += iconos_abajo("Tiempo Transcurrido",accion_dias,"text-info","far fa-clock","text-info","control");
