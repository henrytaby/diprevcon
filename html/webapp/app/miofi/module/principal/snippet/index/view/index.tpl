                    ...
                    <div class="h-100">
                        ...
                        <div class="pt-1">
                            ...
                            <div class="d-flex align-items-center pb-9">
                                ...
                                <!--end::Text-->
                                <!--begin::label-->
                                <span class="font-weight-bolder label label-xl label-light-danger label-inline px-3 py-5 min-w-45px">15</span>
                                <!--end::label-->
                            </div>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center pb-9">
                                ...
                                <!--end::Text-->
                                <!--begin::label-->
                                <span class="font-weight-bolder label label-xl label-light-primary label-inline py-5 min-w-45px">48</span>
                                <!--end::label-->
                            </div>
                            <!--end::Item-->
                        </div>
